...
def plot_err_line(error_list:List, name:List,filesave:str, yaxis_title:str = 'range error',
                  xaxis_title:str = 'Chunk No.',color_list:List =  ['brown','blue','green'],
...
def plot_nlearn_line(nlearnl:List, name:List, filesave:str,
                     yaxis_title:str = 'numbers of samples for boostraping',
                     xaxis_title:str = 'Chunk No.',color_list:List =  ['brown','blue','green'],
                     position:str = 'middle-right'):
    # Sample data for the line plots
...
def plot_minmax_line(exp_l:List, exp_r:List, name_l:List,name_r:List, popminmax:List,filesave:str,
                     yaxis_title:str = 'Value',xaxis_title:str = 'Chunk No.',
...
for filename in filename_list:
    ...
    print(f'min = {pop_min:.4f} and max = {pop_max:.4f}')
    ...
    for idx in range(len(exp_l)):
        ...
        plot_minmax_line(exp_l[idx], exp_r[idx], name_l[idx],name_r[idx], popminmax,
                         filesave = os.path.join(figure_path,filename+name[idx][0]))
        plot_err_line(error_range[idx], name[idx],
                      filesave = os.path.join(figure_path,filename+name[idx][0]+'error'),position = 'top-right')
        plot_nlearn_line(nlearn[idx], name[idx], 
