...
def parse_opt():
    ...
    parser.add_argument("--dir", type = str, default=ROOT/"config_sim_data/wiebull", help = 'working directory')
    parser.add_argument("--file", type = str, default="config_wiebull_simulate.yaml", help = 'config file')
