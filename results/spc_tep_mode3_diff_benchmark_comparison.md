...
| **ARL1 (Detection Delay)** | 1.68 | 1.00 | nan | **1.55** | Fast Failure Response |
| **Peak Memory Footprint (KB)** | 1.15 KB | 2.30 KB | 582.87 KB | **3.23 KB** | **Constant $O(D)$ RAM Footprint** |
| **Avg Latency per Chunk (ms)** | 0.5973 ms | 4.4194 ms | 5.2910 ms | **11.7796 ms** | Real-time Stream Execution |
