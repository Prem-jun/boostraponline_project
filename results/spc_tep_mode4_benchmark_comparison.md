...
| **ARL1 (Detection Delay)** | 1.34 | 1.00 | 1.00 | **1.54** | Fast Failure Response |
| **Peak Memory Footprint (KB)** | 1.15 KB | 2.30 KB | 582.87 KB | **3.23 KB** | **Constant $O(D)$ RAM Footprint** |
| **Avg Latency per Chunk (ms)** | 0.5680 ms | 4.1665 ms | 4.3526 ms | **11.9477 ms** | Real-time Stream Execution |
