...
|---|---|---|---|---|---|
| **Overall Coverage Rate (%)** | 100.00% | 99.91% | 98.95% | **99.40%** | Non-Gaussian Adaptive Bounds |
...
| **Avg Latency per Chunk (ms)** | 0.0760 ms | 0.2270 ms | 1.8951 ms | **10.9696 ms** | Real-time Streaming (< 70 ms) |
