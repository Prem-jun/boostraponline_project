...
|---|---|---|---|---|---|
| **Overall Coverage Rate (%)** | 80.80% | 60.99% | 99.01% | **93.70%** | High-Dimensional Non-Gaussian Coverage |
| **Sample-level FAR (%)** | 19.20% | 39.01% | 0.99% | **6.30%** | Controlled near Bonferroni $\alpha_{dim}$ |
...
| **Avg Latency per Chunk (ms)** | 0.5522 ms | 3.6034 ms | 4.1490 ms | **10.5346 ms** | Real-time Stream Execution |
