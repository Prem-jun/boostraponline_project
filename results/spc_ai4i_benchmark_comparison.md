...
| **ARL1 (Detection Delay)** | 1.02 | 1.00 | 2.29 | **1.14** | Fast Failure Response |
| **Peak Memory Footprint (KB)** | 0.23 KB | 0.45 KB | 413.78 KB | **0.52 KB** | **Constant $O(D)$ RAM Footprint** |
| **Avg Latency per Chunk (ms)** | 0.0561 ms | 0.3189 ms | 1.7944 ms | **69.9797 ms** | Real-time Streaming (< 70 ms) |
