...
| **Chunk-level FAR (%)** | 100.00% | 100.00% | 0.00% | **0.00%** | Low Chunk False Alarm Rate |
| **ARL0 (In-Control Run Length)** | 0.00 | 0.00 | 6.00 | **6.00** | Higher In-Control Stability |
| **ARL1 (Detection Delay)** | 1.02 | 1.00 | 4.73 | **5.57** | Fast Failure Response |
| **Peak Memory Footprint (KB)** | 0.23 KB | 0.45 KB | 413.78 KB | **0.52 KB** | **Constant $O(D)$ RAM Footprint** |
| **Avg Latency per Chunk (ms)** | 0.0142 ms | 0.1965 ms | 0.9299 ms | **35.9981 ms** | Real-time Streaming (< 70 ms) |
