...
| **Chunk-level FAR (%)** | 99.80% | 100.00% | 96.83% | **95.61%** | Low Batch False Alarm Rate |
...
| **Avg Latency per Chunk (ms)** | 0.2635 ms | 3.1581 ms | 238.7620 ms | **8.3219 ms** | Low Latency Stream Processing |
