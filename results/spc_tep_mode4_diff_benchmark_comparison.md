...
| **ARL1 (Detection Delay)** | 1.75 | 1.58 | nan | **1.73** | Fast Failure Response |
| **Peak Memory Footprint (KB)** | 1.15 KB | 2.30 KB | 582.87 KB | **3.23 KB** | **Constant $O(D)$ RAM Footprint** |
| **Avg Latency per Chunk (ms)** | 0.6073 ms | 4.6956 ms | 4.7476 ms | **12.0804 ms** | Real-time Stream Execution |
