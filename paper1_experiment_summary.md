...
### 2.5 One-Step-Ahead Coverage — protocol ที่สะท้อนการใช้งานจริง
...
### 2.6 Interval Width — ตัวคู่ที่ต้องอ่านพร้อม Coverage
...
### 2.7 Memory Usage — จุดแข็งที่แท้จริง
