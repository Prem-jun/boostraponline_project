...
if __name__ == "__main__":
    ...
    # config_list_path = "config_sim_data/wald/results_config_files.yaml"
    config_list_path = "config_sim_data/wald/results_config_files_outlier.yaml"
    results_dir = "config_sim_data/wald"
